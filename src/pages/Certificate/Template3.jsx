...
const Certificate3 = ({ data, isPreview }) => {
  ...
  const renderTheoryRows = () => { 
    return data.marks
      ...
      .map((mark, index) => (
        <tr key={index}>
          <td style={getCellStyle(mark.code)}><center >{String(mark.code).padStart(3, '0')}</center></td>
          <td style={getCellStyle(mark.name)}><div style={{textAlign:"left",padding:"0px 0px 0px 3px"}}>{mark.name}</div></td>
          <td style={getCellStyle(mark.maxMarks)}><center style={{fontSize:"20px"}}>{mark.maxMarks}</center></td>
        ...
        <div style={{ border: "3px solid", padding: "5px 4px 10px 4px" }}>
          ...
          <div className="responsive">
            <table border="2" className="table-bordered" style={{ borderCollapse: 'collapse', fontSize: "0.8rem", padding: "4px" }}>
              <thead>
                <tr>
                  <th rowSpan="4" className="text-center" style={{ border: '1px solid black', padding: '4px' }}>प्रश्‍न्पत्र कोड</th>
                  <th rowSpan="4" className="text-center" style={{ border: '1px solid black', padding: '4px' }}>प्रश्‍न्पत्र का नाम</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style={{ border: '1px solid black', padding: "4px  0px 12px 0px", textAlign: 'center',fontSize:"20px" }}>{data.maxMarks}</td>
