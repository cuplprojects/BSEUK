...
const Certificate2 = ({ data, isPreview }) => {
  ...
  const totalTheoryMax = data.marks.reduce(
    (acc, mark) => acc + mark.theoryMax,
    0
  );
  const totalInternalMax = data.marks.reduce(
    (acc, mark) => acc + mark.internalMax,
    0
  );
  const totalPracticalMax = data.marks
    .filter((mark) => mark.type === 2)
    .reduce((acc, mark) => acc + mark.maxMarks, 0);
  const totalInternal = data.marks.reduce(
    (acc, mark) => acc + mark.internal,
    0
  );
  const totalPractical = data.marks.reduce(
    (acc, mark) => acc + mark.practical,
    0
  );
  ...
  const grandTotal = data.OverAllDetails.results.reduce((acc, mark) => {
    ...
    return (
      acc +
      mark.totalTheoryMarks +
      mark.totalInternalMarks +
      mark.totalPracticalMarks
    );
  }, 0);
    ...
    return data.marks
      ...
      .map((mark, index) => (
        <tr key={index}>
          ...
          >
            {mark.code === 1001 ? "" : String(mark.code).padStart(3, "0")}{" "}
            {mark.code === 1001 ? "" : "-"} {mark.name}
          </td>
          <td
            style={{
              border: "1px solid #C00000",
          ...
          <th
            ...
            style={{
              ...
              borderTop:
                index === 0 ? "1px solid #C00000" : "1px solid #C00000",
              padding: "4px 0px 12px 0px",
              fontSize: "1.5rem",
            }}
          >
    ...
    return practicalMarks.map((mark, index) => (
      <tr key={index}>
        <td
          ...
          style={{
            border: "1px solid #C00000",
            borderTop: index === 0 ? "2px solid #C00000" : "1px solid #C00000",
            textAlign: "left",
    ...
    return data?.OverAllDetails.results.map((mark, index) => (
      <tr>
        ...
        >
          {mark.semID === 4
            ? "-"
            : mark.totalTheoryMaxMarks + mark.totalInternalMaxMarks}
        </td>
        {/* ------------------------------------------------------ */}
        <td
          style={{
        ...
        >
          {mark.semID === 4
            ? mark.overallTotalMaxMarks
            : mark.totalPracticalMaxMarks}
        </td>
        {/* ------------------------------------------------------ */}
  ...
  return (
    <div
      className="p-4 "
      style={{ position: "relative", fontFamily: "Times New Roman, serif" }}
    >
      <div
        style={{
          position: "absolute",
      ...
      >
        <div
          style={{ border: "3px solid #C00000", padding: "5px 4px 10px 4px" }}
        >
          <div>
            <b style={{ fontSize: "1.5rem" }}>
              {/* Sr. No.<span>{String(data.sno).padStart(3, "0")}</span> */}
              <span style={{ color: "#4F6228" }}>Sr. No.</span>{" "}
              <span>{data.awardsheetnumber}</span>
            </b>
          </div>
          ...
          <div className="text-center mb-1">
            ...
            >
              प्रारम्भिक शिक्षा में द्विवर्षीय डिप्लोमा- 20
              {data.entersession || data.session.split("-")[1]}
            </h4>
            <h4
              style={{
                fontSize: "1.5rem",
            ...
            >
              TWO-YEAR DIPLOMA IN ELEMENTARY EDUCATION - 20
              {data.entersession || data.session.split("-")[1]}
            </h4>
          </div>
          ...
          <section className="mb-4">
            ...
            >
              <div className="">
                <span
                  style={{ fontSize: "1.2rem", color: "#C00000" }}
                  className=""
                >
                  <b>
                    नाम <br />
              ...
              <div>
                <span style={{ fontSize: "1.2rem", color: "#C00000" }}>
                  <b>
                    अनुक्रमांक <br />
                    Roll No.
                  </b>{" "}
            ...
            >
              <div style={{}}>
                <b style={{ fontSize: "1.2rem", color: "#C00000" }}>
                  माता का नाम <br />
                  Mother's Name
                </b>{" "}
                <span
            ...
            <div className="row">
              <div className="col-md-12 " style={{display:"grid",gridTemplateColumns:"1.5fr 5fr"}}>
                <div className="div1">
                  <b style={{ fontSize: "1.2rem", color: "#C00000" }}>
                    संस्थान का नाम <br />
                    Institution's Name
                ...
                <div className="div2" style={{display:"flex", alignItems:"end"}}>
                  <span
                    className=""
                    style={{ fontSize: ".95rem", textTransform: "upperCase" }}
                  >
            ...
            >
              <thead>
                ...
                >
                  ...
                  >
                    विषय / विद्यालय अनुभव <br />
                    SUBJECT / SCHOOL INTERNSHIP
                  </td>
                  <td
                    colSpan="2"
                    className="text-center"
              ...
              <tr>
                <td
                  ...
                  style={{
                    ...
                    color: "#C00000",
                    borderRight: "1px solid #C00000",
                    borderTop: "1px solid #C00000",
                    borderLeft: "1px solid #C00000",
                    borderBottom: "2px solid #C00000",
                    fontSize: "1rem",
                  }}
                >
                  चतुर्थ सेमेस्टर के प्राप्तांकों का योग
                </td>
                <td
                  style={{
                    border: "1px solid #C00000",
                ...
                >
                  {totalInternalMax + totalPracticalMax}
                </td>
                <td
                  style={{
                    border: "1px solid #C00000",
                ...
                >
                  {totalInternalMax + totalPracticalMax + totalTheoryMax}
                </td>
                <td
                  style={{
                    border: "1px solid #C00000",
            ...
            >
              ...
              <tbody>
                ...
                <tr>
                  ...
                  >
                    {data?.OverAllDetails.totalPracticalMarks}{" "}
                  </th>
                  <th
                    colSpan=""
                    className="text-center"
